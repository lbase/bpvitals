...
class Ui_Menu(object):
    def setupUi(self, Menu):
        ...
        self.btnRefresh.setGeometry(QtCore.QRect(960, 120, 102, 31))
        ...
        self.ketonecombo = QtWidgets.QComboBox(Menu)
        self.ketonecombo.setGeometry(QtCore.QRect(530, 100, 93, 31))
        self.ketonecombo.setEditable(True)
        self.ketonecombo.setObjectName("ketonecombo")
        self.ketone_label = QtWidgets.QLabel(Menu)
        self.ketone_label.setGeometry(QtCore.QRect(540, 140, 76, 21))
        self.ketone_label.setObjectName("ketone_label")
    ...
    def retranslateUi(self, Menu):
        ...
        self.ketone_label.setText(_translate("Menu", "<html><head/><body><p>ketone</p></body></html>"))
import resource_rc
